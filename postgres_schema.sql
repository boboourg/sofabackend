...
CREATE TABLE season_cup_tree_round (
...
CREATE TABLE season_cup_tree_block (
...
CREATE TABLE season_cup_tree_participant (
...
CREATE INDEX idx_season_round_ut_season ON season_round(unique_tournament_id, season_id);
CREATE INDEX idx_season_cup_tree_ut_season ON season_cup_tree(unique_tournament_id, season_id);
CREATE INDEX idx_season_cup_tree_round_cup_tree ON season_cup_tree_round(cup_tree_id, round_order);
