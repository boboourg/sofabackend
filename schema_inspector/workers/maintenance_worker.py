    ...
    def __init__(
        ...
        *,
        ...
        reclaim_targets: tuple[ReclaimTarget, ...] = (
            ...
            ReclaimTarget(stream=STREAM_LIVE_TIER_1, group=GROUP_LIVE_TIER_1),
            ReclaimTarget(stream=STREAM_LIVE_TIER_2, group=GROUP_LIVE_TIER_2),
            ReclaimTarget(stream=STREAM_LIVE_TIER_3, group=GROUP_LIVE_TIER_3),
