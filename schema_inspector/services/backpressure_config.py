...
LIVE_TIER_1_MAX_LAG = _env_int("LIVE_TIER_1_MAX_LAG", LIVE_HOT_MAX_LAG)
LIVE_TIER_2_MAX_LAG = _env_int("LIVE_TIER_2_MAX_LAG", LIVE_HOT_MAX_LAG)
LIVE_TIER_3_MAX_LAG = _env_int("LIVE_TIER_3_MAX_LAG", LIVE_HOT_MAX_LAG)
