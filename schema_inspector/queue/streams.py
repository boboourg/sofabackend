...
GROUP_DISCOVERY = "cg:discovery"
GROUP_HYDRATE = "cg:hydrate"
GROUP_NORMALIZE = "cg:normalize"
GROUP_HISTORICAL_DISCOVERY = "cg:historical_discovery"
GROUP_HISTORICAL_TOURNAMENT = "cg:historical_tournament"
GROUP_HISTORICAL_BOOTSTRAP = "cg:historical_bootstrap"
GROUP_HISTORICAL_ENRICHMENT = "cg:historical_enrichment"
...
STRUCTURE_CONSUMER_GROUPS = (
    (STREAM_STRUCTURE_SYNC, GROUP_STRUCTURE_SYNC),
)

RESOURCE_REFRESH_CONSUMER_GROUPS = (
    (STREAM_RESOURCE_REFRESH, GROUP_RESOURCE_REFRESH),
)

NORMALIZE_CONSUMER_GROUPS = (
    (STREAM_NORMALIZE, GROUP_NORMALIZE),
)
