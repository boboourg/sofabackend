...
class SurfaceCorrectionDetectorTests(unittest.TestCase):
    def test_detect_skips_correction_when_existing_higher_priority_source_wins(self) -> None:
        from schema_inspector.event_list_parser import EventListBundle, EventRecord, EventScoreRecord
    ...
    def test_detect_allows_same_priority_source_by_default(self) -> None:
        from schema_inspector.event_list_parser import EventListBundle, EventRecord, EventScoreRecord
        from schema_inspector.services.surface_correction_detector import (
            SurfaceCorrectionDetector,
            SurfaceEventState,
        ...
        corrections = detector.detect(
            ...
            existing_source_slug="sofascore",
            incoming_source_slug="sofascore",
        )
